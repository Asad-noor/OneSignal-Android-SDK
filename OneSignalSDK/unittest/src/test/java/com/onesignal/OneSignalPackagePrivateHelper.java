...
public class OneSignalPackagePrivateHelper {
   ...
   public static int NotificationBundleProcessor_Process(Context context, boolean restoring, JSONObject jsonPayload, OSNotificationGenerationJob.OverrideSettings overrideSettings) {
